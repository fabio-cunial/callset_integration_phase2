...
END
        ...
        while read LINE; do
            ...
            cp ${SAMPLE_ID}_sv_supp.vcf.gz ${SAMPLE_ID}_raw_truvari.vcf.gz
            cp ${SAMPLE_ID}_sv_supp.vcf.gz.tbi ${SAMPLE_ID}_raw_truvari.vcf.gz.tbi
            ...
            # Uploading
            gcloud storage mv ${SAMPLE_ID}_raw_truvari.vcf.'gz*' ${SAMPLE_ID}_kanpig.vcf.'gz*' ${SAMPLE_ID}_training.vcf.'gz*' ~{remote_outdir}/
