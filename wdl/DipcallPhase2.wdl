...
# The same WDL as in:
#
# https://dockstore.org/workflows/github.com/human-pangenomics/hpp_production_workflows/Dipcall:master?tab=info
#
# but with an explicit PAR BED in input.
#
task dipcall {
    input {
