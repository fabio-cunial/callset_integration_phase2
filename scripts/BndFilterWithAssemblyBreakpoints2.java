 ...
 * - all the internal matching logic works on 0-based positions.
 */
public class BndFilterWithAssemblyBreakpoints2 {
     ...
     *    be represented by two symmetric records; generated by 
    ...
    /**
     * Remark: this procedure focuses on the left side of `query`. If no match
     ...
     * prioritized over unmated matches that match the query only on this side.
