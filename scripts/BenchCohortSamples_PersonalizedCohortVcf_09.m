INPUT_DIR_102='/Users/fcunial/Downloads/BenchCohortSamples_PersonalizedCohortVcf/09_kanpig_1_0_2';
FONT_SIZE=14;
...
xticks([1:length(MIN_N_SAMPLES_102)+1]); xticklabels(LABELS); xlabel('Min n. samples'); title('All calls, 09'); grid on; axis([0,length(LABELS)+1,0,1]); axis square; legend('precision 1.0.2','recall 1.0.2','F1 1.0.2','GT concordance 1.0.2','location','southoutside'); set(gca,'fontsize',FONT_SIZE);
...
line ([1 1+length(MIN_N_SAMPLES_102)], [A(1,3) A(1,3)], "linestyle", "--", "color", "g");
line ([1 1+length(MIN_N_SAMPLES_102)], [A(1,4) A(1,4)], "linestyle", "--", "color", "m");
xticks([1:length(MIN_N_SAMPLES_102)+1]); xticklabels(LABELS); xlabel('Min n. samples'); title('Inside TR, 09'); grid on; axis([0,length(LABELS)+1,0,1]); axis square; legend('precision 1.0.2','recall 1.0.2','F1 1.0.2','GT concordance 1.0.2','location','southoutside'); set(gca,'fontsize',FONT_SIZE);
...
line ([1 1+length(MIN_N_SAMPLES_102)], [A(1,3) A(1,3)], "linestyle", "--", "color", "g");
line ([1 1+length(MIN_N_SAMPLES_102)], [A(1,4) A(1,4)], "linestyle", "--", "color", "m");
xticks([1:length(MIN_N_SAMPLES_102)+1]); xticklabels(LABELS); xlabel('Min n. samples'); title('Outside TR, 09'); grid on; axis([0,length(LABELS)+1,0,1]); axis square; legend('precision 1.0.2','recall 1.0.2','F1 1.0.2','GT concordance 1.0.2','location','southoutside'); set(gca,'fontsize',FONT_SIZE);
