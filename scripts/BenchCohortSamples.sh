#!/bin/bash
#
INPUT_DIR="/Users/fcunial/Downloads/BenchCohortSamples"
...
for SAMPLE in ${SAMPLES}; do
    for STEP in kanpig 07 09 cohort_merged_07 cohort_merged_09 cohort_regenotyped_07 cohort_regenotyped_09; do
        for REGION in all tr not_tr; do
            P=$(grep precision ${INPUT_DIR}/${SAMPLE}_${STEP}_${REGION}.json | cut -w -f 3)
            R=$(grep recall ${INPUT_DIR}/${SAMPLE}_${STEP}_${REGION}.json | cut -w -f 3)
