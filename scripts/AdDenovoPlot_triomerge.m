...
INPUT_DIR='gt_matrix_only50bp';  % INPUT_DIR='gt_matrix_new';
PREFIX='only_50bp';
X=[0:MAX_AD];
for i=[1:N_CHILDREN]
    figure(N_CHILDREN+i);
    ...
    subplot(2,3,1); hold on;
    BB=load(sprintf('%s/%s/%s_%s_all_gtmatrix.txt_ins_depth_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    ...
    subplot(2,3,2); hold on;
    BB=load(sprintf('%s/%s/%s_%s_tr_gtmatrix.txt_ins_depth_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    ...
    subplot(2,3,3); hold on;
    BB=load(sprintf('%s/%s/%s_%s_not_tr_gtmatrix.txt_ins_depth_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    ...
    subplot(2,3,4); hold on;
    BB=load(sprintf('%s/%s/%s_%s_all_gtmatrix.txt_del_depth_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    ...
    subplot(2,3,5); hold on;
    BB=load(sprintf('%s/%s/%s_%s_tr_gtmatrix.txt_del_depth_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    ...
    subplot(2,3,6); hold on;
    BB=load(sprintf('%s/%s/%s_%s_not_tr_gtmatrix.txt_del_depth_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
...
for i=[1:N_CHILDREN]
    ...
    subplot(2,3,1); hold on;
    BB=load(sprintf('%s/%s/%s_%s_all_gtmatrix.txt_ins_len_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    axis square; grid on; axis([0,1000,0,0.6]); xlabel('SVLEN'); ylabel('De novo rate'); title('All INS'); set(gca,'fontsize',FONT_SIZE);
    
    subplot(2,3,2); hold on;
    BB=load(sprintf('%s/%s/%s_%s_tr_gtmatrix.txt_ins_len_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    axis square; grid on; axis([0,1000,0,0.6]); xlabel('SVLEN'); ylabel('De novo rate'); title('INS in TRs'); set(gca,'fontsize',FONT_SIZE);
    
    subplot(2,3,3); hold on;
    BB=load(sprintf('%s/%s/%s_%s_not_tr_gtmatrix.txt_ins_len_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    axis square; grid on; axis([0,1000,0,0.6]); xlabel('SVLEN'); ylabel('De novo rate'); title('INS outside TRs'); set(gca,'fontsize',FONT_SIZE);
    
    subplot(2,3,4); hold on;
    BB=load(sprintf('%s/%s/%s_%s_all_gtmatrix.txt_del_len_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    axis square; grid on; axis([0,1000,0,0.6]); xlabel('SVLEN'); ylabel('De novo rate'); title('All DEL'); set(gca,'fontsize',FONT_SIZE);
    
    subplot(2,3,5); hold on;
    BB=load(sprintf('%s/%s/%s_%s_tr_gtmatrix.txt_del_len_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    axis square; grid on; axis([0,1000,0,0.6]); xlabel('SVLEN'); ylabel('De novo rate'); title('DEL in TRs'); set(gca,'fontsize',FONT_SIZE);
    
    subplot(2,3,6); hold on;
    BB=load(sprintf('%s/%s/%s_%s_not_tr_gtmatrix.txt_del_len_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
...
INPUT_DIR='gt_matrix_only50bp';  % INPUT_DIR='gt_matrix_numneigh';
PREFIX='only_50bp';
...
for i=[1:N_CHILDREN]
    ...
    subplot(2,3,1); hold on;
    BB=load(sprintf('%s/%s/%s_%s_all_gtmatrix.txt_numneigh_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    axis square; grid on; axis([-1,11,0,0.6]); xlabel('NumNeighbors'); ylabel('De novo rate'); title('All calls'); set(gca,'fontsize',FONT_SIZE);
    
    subplot(2,3,4); hold on;
    BB=load(sprintf('%s/%s/%s_%s_all_gtmatrix.txt_numneigh.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    ...
    subplot(2,3,2); hold on;
    BB=load(sprintf('%s/%s/%s_%s_tr_gtmatrix.txt_numneigh_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    axis square; grid on; axis([-1,11,0,0.6]); xlabel('NumNeighbors'); ylabel('De novo rate'); title('Inside TRs'); set(gca,'fontsize',FONT_SIZE);
    
    subplot(2,3,5); hold on;
    BB=load(sprintf('%s/%s/%s_%s_tr_gtmatrix.txt_numneigh.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    ...
    subplot(2,3,3); hold on;
    BB=load(sprintf('%s/%s/%s_%s_not_tr_gtmatrix.txt_numneigh_to_denovo_rate.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
    axis square; grid on; axis([-1,11,0,0.6]); xlabel('NumNeighbors'); ylabel('De novo rate'); title('Outside TRs'); set(gca,'fontsize',FONT_SIZE);
    
    subplot(2,3,6); hold on;
    BB=load(sprintf('%s/%s/%s_%s_not_tr_gtmatrix.txt_numneigh.txt',SOURCE_DIR,INPUT_DIR,CHILDREN{i},PREFIX));
    plot(X,BB,'.');
