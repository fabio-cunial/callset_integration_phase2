...
while read CHILD_ID; do
    ...
    for SUFFIX in AllHomopolymers AllTandemRepeats satellites microsatellite segdups segdups_gt10kb numts gc15 gc15to20 gc20to25 gc25to30 gc30to55 gc55to60 gc60to65 gc65to70 gc70to75 gc75to80 gc80to85 gc85; do
