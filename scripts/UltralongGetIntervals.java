...
/**
 * Given an ultralong VCF, the program prints an output BED (zero-based, left-
 * inclusive, right-exclusive) a record for each call.
 */
public class UltralongGetIntervals {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final int SLACK_BP = Integer.parseInt(args[2]);
        
        int i, p;
        int chromLength, pos, svlen, intervalStart, intervalEnd;
        String str, chrom, info, svtype;
        BufferedReader br;
        String[] tokens;
        ...
        while (str!=null) {
            ...
            intervalStart=pos-SLACK_BP;
            if (svtype.equals("INS")) intervalEnd=pos+SLACK_BP;
            else intervalEnd=pos+svlen+SLACK_BP;
            System.out.println(chrom+"\t"+(intervalStart>=0?intervalStart:0)+"\t"+(intervalEnd<=chromLength?intervalEnd:chromLength));
