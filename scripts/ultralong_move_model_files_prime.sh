...
REMOTE_DESTINATION_URI_15x="${REMOTE_BUCKET_URI}/v3/15x/workpackage_1_bnd_annotated_fourth_attempt/merged/scored_final_model"
REMOTE_DESTINATION_URI_30x="${REMOTE_BUCKET_URI}/v3/30x/workpackage_1_bnd_annotated_fourth_attempt/merged/scored_final_model"
