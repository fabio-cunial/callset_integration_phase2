...
for REGION in all tr not_tr; do
    ...
    rm -f precision_recall_30x_20bp_${REGION}.csv
    for SAMPLE in ${PRECISION_RECALL_SAMPLES_30x}; do
        ...
        echo ${ROW} >> precision_recall_30x_20bp_${REGION}.csv
    done
...
for REGION in all tr not_tr; do
    ...
    rm -f mendelian_error_15x_20bp_aou_${REGION}.csv
    for SAMPLE in ${MENDELIAN_ERROR_SAMPLES_15x_AOU}; do
        ...
        echo ${ROW} >> mendelian_error_15x_20bp_aou_${REGION}.csv
    done
    ...
    rm -f mendelian_error_30x_20bp_aou_${REGION}.csv
    for SAMPLE in ${MENDELIAN_ERROR_SAMPLES_30x_AOU}; do
        ...
        echo ${ROW} >> mendelian_error_30x_20bp_aou_${REGION}.csv
    done
...
for REGION in all tr not_tr; do
    ...
    rm -f denovo_15x_20bp_aou_${REGION}.csv
    for SAMPLE in ${MENDELIAN_ERROR_SAMPLES_15x_AOU}; do
        FILE="truvari/mendelian/${SAMPLE}_dnm2_20bp_${REGION}.txt"
        ROW=$(cat ${FILE})
        for MIN in ${N_SAMPLES}; do
        ...
        echo ${ROW} >> denovo_15x_20bp_aou_${REGION}.csv
    done
    ...
    rm -f denovo_30x_20bp_aou_${REGION}.csv
    for SAMPLE in ${MENDELIAN_ERROR_SAMPLES_30x_AOU}; do
        FILE="truvari/mendelian/${SAMPLE}_dnm2_20bp_${REGION}.txt"
        ROW=$(cat ${FILE})
        for MIN in ${N_SAMPLES}; do
        ...
        echo ${ROW} >> denovo_30x_20bp_aou_${REGION}.csv
    done
