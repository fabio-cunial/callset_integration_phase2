...
/**
 * Given two clip files generated by `UltralongIntervalGetClips.java` and then
 * sorted by ID, one for the left breakpoint and one for the right breakpoint of
 * a given SV interval, the program returns the number of alignments in each 
 * file such that:
 *
